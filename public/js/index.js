...
},{"../Helpers":8}],5:[function(require,module,exports){
'use strict';
...
var HeaderComponent = exports.HeaderComponent = function (_BaseComponent) {
    ...
    _createClass(HeaderComponent, [{
        ...
        value: function _events() {
            ...
            (0, _jquery2.default)(".menu, .logo").on("click", "a", function (e) {
...
},{"../Base/BaseComponent":4,"jquery":2}],6:[function(require,module,exports){
'use strict';
...
},{"../Helpers":8,"../Modules/GoogleApi":9,"jquery":2}],7:[function(require,module,exports){
'use strict';
...
},{"../../../node_modules/remodal/src/remodal":3,"jquery":2}],8:[function(require,module,exports){
'use strict';
...
},{"google-maps":1}],10:[function(require,module,exports){
'use strict';
...
var _scheduleRu = require('../lang/ru/schedule-ru.js');

var _scheduleEn = require('../lang/en/schedule-en.js');
...
var RenderSchedule = exports.RenderSchedule = function () {
  function RenderSchedule() {
    ...
    this.popup = new _Popup.Popup('#speakers-modal');
    this.CONFIG = window.CONFIG;
    this.schedule = null;
    this._init();
    this._events();
  ...
  _createClass(RenderSchedule, [{
    ...
    value: function _init() {
      if (this.CONFIG.LANG === 'ru') {
        this.schedule = _scheduleRu.ScheduleRu;
      } else {
        this.schedule = _scheduleEn.ScheduleEn;
      }

      var scheduleRow = '<div class="schedule-item">' + '                <div class="schedule-time">${ time }</div>' + '                <div class="schedule-icon ${ icon }"></div>' + '                    {{html scheduleRendered}}' + '              </div>';
      _jquery2.default.template('scheduleRow', scheduleRow);

      var scheduleItem = '<div class="schedule-text flex-item-1">' + '                  {{html title}}' + '                  <div class="schedule-author">' + '                    ${author}' + '                  </div>' + '                </div>';
      ...
      (0, _jquery2.default)('#schedule-list .schedule-body').html(scheduleHtml);
    }
  }, {
    key: '_events',
    value: function _events() {}
...
},{"../Components/Popup":7,"../Helpers":8,"../lang/en/schedule-en.js":14,"../lang/ru/schedule-ru.js":16,"../vendors/jquery-tmpl/jquery.tmpl.min":18,"jquery":2}],12:[function(require,module,exports){
'use strict';
...
var _speakersRu = require('../lang/ru/speakers-ru.js');

var _speakersEn = require('../lang/en/speakers-en.js');
...
var RenderSpeakers = exports.RenderSpeakers = function () {
  ...
  _createClass(RenderSpeakers, [{
    ...
    value: function _init() {
      if (this.CONFIG.LANG === 'ru') {
        this.speakers = _speakersRu.SpeakersRu;
      } else {
        this.speakers = _speakersEn.SpeakersEn;
      }

      if (localStorage.speakersModalHtml && location.hash.search(/speakers-modal/) > -1) {
        (0, _jquery2.default)('#speakers-modal').html(localStorage.speakersModalHtml);
      }

      var speakerItem = '<div class="speaker-item">' + '<div data-remodal-target="speakers-modal" data-item-index="__ReplaceWithIndex">' + '<div class="speaker-img">' + '<img src="${image}" alt="${name}">' + '</div>' + '<div class="speaker-name">${name}</div>' + '<div class="speaker-position">${position} ' + '{{if company}}' + '@${company}' + '{{/if}}' + '</div>' + '<div class="speaker-report">' + '{{each rept }} {{html $value.title}} {{if $value.title}}</br> </br>{{/if}}{{/each}}' + '</div>' + '</div>' + '<div class="speaker-socials">{{html socialsRendered}}</div>' + '</div>';
      ...
      (0, _jquery2.default)('#speakers-list').html(spekersHtml);
    }
  }, {
    key: '_events',
    value: function _events() {
      ...
      (0, _jquery2.default)(document).on('click', '[data-remodal-target="speakers-modal"]', function () {
        var $speakerInfoBlock = (0, _jquery2.default)(this);
        loadSpeakerModal($speakerInfoBlock);
      });

      function loadSpeakerModal($speakerInfoBlock) {
        var $modalBody = (0, _jquery2.default)('#speakers-modal'),
        ...
        $prevButton.unbind('click').click(function () {
          var prevIndex = speakerIndex == 0 ? that.speakers.length - 1 : speakerIndex - 1;
          that.helpers.showLoader($modalBody);

          setTimeout(function () {
            loadSpeakerModal((0, _jquery2.default)('[data-item-index="' + prevIndex + '"]'));
          }, 600);
        });

        $nextButton.unbind('click').click(function () {
          var nextIndex = speakerIndex == that.speakers.length - 1 ? 0 : speakerIndex + 1;
          that.helpers.showLoader($modalBody);

          setTimeout(function () {
            loadSpeakerModal((0, _jquery2.default)('[data-item-index="' + nextIndex + '"]'));
          }, 600);
        });

        var speakerData = that.speakers[speakerIndex];
...
},{"../Components/Popup":7,"../Helpers":8,"../lang/en/speakers-en.js":15,"../lang/ru/speakers-ru.js":17,"../vendors/jquery-tmpl/jquery.tmpl.min":18,"jquery":2}],13:[function(require,module,exports){
'use strict';
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function _initModules() {
      new _RenderSpeakers.RenderSpeakers();
      new _RenderSchedule.RenderSchedule();
...
},{"./Components/Header":5,"./Components/Map":6,"./Modules/LazyLoad":10,"./Modules/RenderSchedule":11,"./Modules/RenderSpeakers":12,"jquery":2}],14:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var ScheduleEn = exports.ScheduleEn = [{
  time: '9.30-10.30',
  icon: 'profile',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Регистрация' }, { author: '', title: '' }]
}, {
  time: '10.30-10.40',
  icon: 'people',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Открытие' }, { author: '', title: '' }]
}, {
  time: '10.40-11.20',
  icon: 'people',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Начало конференции' }, { author: '', title: 'Доклад 1' }]
}, {
  time: '11.20-11.40',
  icon: 'clock',
  scheduleRendered: '',
  ...
  icon: 'sheet',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Доклад 2' }, { author: '', title: '' }]
}, {
  time: '12.20-12.40',
  icon: 'cup',
  scheduleRendered: '',
  ...
  icon: 'sheet',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Доклад 3' }, { author: '', title: '' }]
}, {
  time: '13.30-15.00',
  icon: 'plate',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Обед' }, { author: '', title: '' }]
}, {
  time: '15.00-15.40',
  icon: 'sheet',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Доклад 4' }, { author: '', title: '' }]
}, {
  time: '15.40-16.00',
  icon: 'clock',
  scheduleRendered: '',
  ...
  icon: 'sheet',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Доклад 5' }, { author: '', title: '' }]
}, {
  time: '16.40-17.10',
  icon: 'cup',
  scheduleRendered: '',
  ...
  icon: 'sheet',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Доклад 6' }, { author: '', title: '' }]
}, {
  time: '17.50-18.10',
  icon: 'clock',
  scheduleRendered: '',
  ...
  icon: 'sheet',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Доклад 7' }, { author: '', title: '' }]
}, {
  time: '19.00',
  icon: 'people',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Закрытие конференции' }, { author: '', title: '' }]
}];
...
var SpeakersEn = exports.SpeakersEn = [
// {
...
// },
{
  ...
  rept: [{
    ...
    description: 'Distributed systems - how to arrange and how you can practically apply ' + 'distributed data structures based on ideas from the field of CRDT'
  }, {
...
// },
{
  ...
  rept: [{
    ...
    description: 'В ходе беседы поговорим о некоторых весьма полезных инструментах, для генерации стартового ' + 'состояние проекта, автоматической настройки основных компонентов. В общем, как автоматизировать все то, что' + ' каждый раз приходится делать, но не очень хочется'
  }],
  aboutSpeaker: '',
  socialsRendered: '',
  socials: [{
...
var ScheduleRu = exports.ScheduleRu = [{
  time: '9.30-10.30',
  icon: 'profile',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Регистрация' }, { author: '', title: '' }]
  ...
  icon: 'people',
  scheduleRendered: '',
  talks: [{ author: '', title: 'Начало конференции <br> <br> Доклад 1' }, { author: '', title: 'Доклад 1' }]
}, {
  time: '11.20-11.40',
  icon: 'clock',
  scheduleRendered: '',
...
var SpeakersRu = exports.SpeakersRu = [
// {
//   image : 'public/img/speakers/nikita_galkin.jpg',
//   name : 'Никита Галкин',
//   position : 'System Architect',
...
// },
{
  ...
  rept: [{
    ...
    description: 'Распределенные системы – как устроены и как можно практически применить ' + 'распределенные структуры данных на базе идей из области CRDT'
  }, {
