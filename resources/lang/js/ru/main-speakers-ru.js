        ...
        rept: [
            {
                ...
                description: "- Специфіка та \"підводні камені\" навантаження в чат-ботах. \n <br>" +
                    "- Можливі варіанти вирішення небезпек.\n <br>" +
                    "- Причини та наслідки проблем при застосуванні класичної архітектури.\n <br>" +
                    "- Історія вирішення на реальному проекті. Використання AWS Lambda, AWS SQS, Golang. <br>"
            },
        ],
        aboutSpeaker:
            '',
        ...
        rept: [
            {
                ...
                " Научиться создавать с нуля либо же добавлять к уже существующемому веб-приложению Node.js возможности PWA (Прогрессивные Веб Приложения), такие как режим Offline и Кеширование с помощью ServiceWorkers. Это будет практический воркшоп, во время которого Вы будете способны создать небольшое веб-приложение с помощью Node.js и возможностями PWA. <br>"+
                "К концу воркшопа Вы будете знать: <br>"+
                '<ul class="m-t-0">\n' +
