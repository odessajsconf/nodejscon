export const MainSpeakersRu = [
      ...
      rept : [
        {
          ...
          description : 'Во время презентации, я перечислю наиболее распространённые проблемы с безопасностью. Расскажу' +
          ' про текущую ситуацию в WEB и объясню как справиться с задачами безопасности. <br> <br>' +
          'Что мы можем сделать чтобы уменьшить уровень не безопасности? Я научу аудиторию справляться с ' +
          '«дырами» в безопасности и объясню обязательные шаги, которые обязательно должны быть сделаны перед ' +
          'выпуском приложения.'
        }
      ],
      aboutSpeaker : '',
    ...
    },
    {
      ...
      rept : [
        {
          title : 'Способы коммуникации между микросервисами [Ru]',
          description : 'Расскажу про три способа коммуникации: HTTP-запросы, WebSockets, RabbitMQ. На примерах объясню, в каких ' +
          'случая уместнее использовать тот или иной способ. '
        }
      ],
      aboutSpeaker : '',
      socialsRendered : '',
