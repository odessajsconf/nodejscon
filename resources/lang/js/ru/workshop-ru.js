        ...
        rept : [
            {
                ...
                description :
                '<p class="text-bold m-b-5">ОПИСАНИЕ</p>' +
                '<p class="m-t-0">Научиться создавать с нуля либо же добавлять к уже существующемому веб-приложению Node.js возможности PWA (Прогрессивные Веб Приложения), такие как режим Offline и Кеширование с помощью ServiceWorkers. Это будет практический воркшоп, во время которого Вы будете способны создать небольшое веб-приложение с помощью Node.js и возможностями PWA.</p>' +
